  ...
  <div class="content-wrapper">
    ...
    <aside class="sidebar">
      <div class="sidebar-content">
        ...
        <div class="sidebar-item active" on:click={() => activeTab = 'posted'}>
          <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
        ...
        <div class="sidebar-item" on:click={() => activeTab = 'accepted'}>
          <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
            <circle cx="8" cy="8" r="7" stroke="currentColor" stroke-width="2"/>
        ...
        <div class="sidebar-item" on:click={() => activeTab = 'favourite'}>
          <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
            <path d="M8 2.5L10.09 6.26L14.27 7.11L11.18 10.06L11.82 14.24L8 12.38L4.18 14.24L4.82 10.06L1.73 7.11L5.91 6.26L8 2.5Z" fill="currentColor"/>
          </svg>
          <span>Favourite</span>
        </div>
        
        <div class="sidebar-item" on:click={() => activeTab = 'reviews'}>
          <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
        ...
        <div class="sidebar-item" on:click={() => activeTab = 'settings'}>
          <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
        ...
        <div class="profile-card">
          <div class="profile-overview">
            <div class="profile-avatar">
              <img 
                src={`https://ui-avatars.com/api/?name=${encodeURIComponent(currentUser.username || currentUser.email)}&size=120&background=ECF86E&color=000`} 
                alt="Profile" 
              />
            </div>
            <div class="profile-info">
              <h2 class="profile-name">{currentUser.username || currentUser.name || 'User'}</h2>
